...
- Local filters are defined in component
...
```
- optinally pass arguments also
```javascript
{{firstName | myDateFilter('MM-DD-YY')}}
```

### Global Filters

- Define once and use every where
- When define a global filter. it must come before the **Vue** instance
...
export default {
  ...
  filters: {
    shortDate: function(value) {
      console.log('Date mismatch debug ' ,value)
